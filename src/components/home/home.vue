...
<div>
  <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
    <div>
      ...
      <dl class="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
        <div class="border-t border-gray-500 pt-4">
          <dt class="font-medium text-gray-300">Origin</dt>
          <dd class="mt-2 text-sm text-gray-300">Designed by Good Goods, Inc.</dd>
        </div>

        <div class="border-t border-gray-500 pt-4">
          <dt class="font-medium text-gray-300">Material</dt>
          <dd class="mt-2 text-sm text-gray-300">Solid walnut base with rare earth magnets and powder coated steel card cover</dd>
        </div>
    ...
    <div class="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
      ...
      <img src="https://tailwindui.com/img/ecommerce-images/product-feature-03-detail-02.jpg" alt="Top down view of walnut card tray with embedded magnets and card groove." class="rounded-lg bg-gray-700">
